...
$users[] = array('name'=>'Rui','image'=>'https://scontent-b-mad.xx.fbcdn.net/hphotos-xaf1/v/t1.0-9/p180x540/10570464_780920845264527_8404809584525041628_n.jpg?oh=7c1e5bc2e3bb5de28c8ce7b35ea29eac&oe=548465EB');
$users[] = array('name'=>'Barak','image'=>'https://d3tgqgdprl4cx9.cloudfront.net/assets/v2/images/team/barak.jpg?v=6034a60a');

foreach($users as $user){
    $user['_id'] = md5($user['name']);
    try{
        print_r($user);
